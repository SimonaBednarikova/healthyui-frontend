...
Hlavné routy sú definované v src/App.jsx:
...
Chránené routy idú cez src/components/RequireAuth.jsx.
...
- src/lib/directus.js – login, refresh token, logout, password reset
- src/context/AuthContext.jsx – držanie používateľa v stave aplikácie
- src/lib/api.js – wrapper na volania Directusu s refresh token logikou
...
- src/lib/prefetchModuleDetail.js
- src/lib/progress.js
